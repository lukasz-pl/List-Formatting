...
![zrzut ekranu scale setting](./assets/Scale.gif)
...
![zrzut ekranu the difference between how the Author and the user see the difference](./assets/Author-User.png)
...
Version |Data              |Uwagi
--------|------------------|--------------------------------
1.0     |marca 22, 2023  |Wersja początkowa
2.0     |listopada 21, 2023  |Added Radar-Chart
