...
![zrzut ekranu the sample (on a Wednesday)](./assets/screenshot-wednesday.png)
...
> =floor(Liczba(Data(@now))/86400/1000)
...
> =(floor(Liczba(Data(@now))/86400/1000)+4)%7
...
> =1577836800000-Liczba(Data('01.01.2020')

Putting it all together we get the following formula to calculate the local day of the week

> =(floor(((Liczba(Data(@now))+1577836800000-Liczba(Data('01.01.2020')))/86400/1000)+4)%7
...
> =floor((1577836800001-Liczba(Data('01.01.2020')))/3600/1000)
...
Wersja|Data|Uwagi
-------|----|--------
1.0|27 listopada 2022|Wersja początkowa
