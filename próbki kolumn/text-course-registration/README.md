...
|Type|Internal Name|Dodatkowe informacje
|---|:---:|---|
...
|Liczba|NumberOfPlaces|Column for the number of available places in the course
...
Wersja |Data          |Uwagi
--------|--------------|--------------------------------
1.0     |listopada 25, 2021 |Wersja początkowa
2.0     |maja 10, 2022 | Dodano unregister functionality
