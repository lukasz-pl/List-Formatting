...
> ![zrzut ekranu the json setting](./assets/json-setting.png)
...
Wersja |Data         |Uwagi
--------|-------------|--------
1.0     |maja 11, 2023 |Wersja początkowa
1.1     |kwietnia 26, 2024 |Dodano `person-assign-to-me-highlight-single.json` and `person-assign-to-me-highlight-multi.json`
1.2     |kwietnia 28, 2024 |Dodano hover effect
1.3     |sierpnia 13, 2024 |Poprawiono the size of the user's image
