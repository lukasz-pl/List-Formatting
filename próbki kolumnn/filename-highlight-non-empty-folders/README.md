...
![zrzut ekranu the sample with hidden columns](./assets/screenshot_hidden_columns.png)
...
Wersja|Data|Uwagi
-------|----|--------
1.0|6 października 2023|Wersja początkowa
2.0|24 stycznia 2024|Included 2nd version with Buttons
